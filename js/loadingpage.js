...
// / one day for each of the 4 seasons with 15min-dates and true/false (is
// critical or not)
// / an array of array: first seasons (spring, summer...) and second associative
// arrays begin-end and the times (1-*)
var hlzfProcessed;

// / this is the array dygraphs gets to draw the graphs; containing dates, and
...
function readyProviders() {
	...
	$.ajax({
		...
		success : function(data) {
			...
			// first, overwrite the first "Zuerst Lastgang auswählen" option and
			// say "Keine Auswahl".
...
function handleFileSelect(evt) {
	...
	reader.onload = function(e) {
		...
		$("button#generate_png_Graph").click(function() {
		...
		$("button#generate_png_FrequencyGraph").click(function() {

			var png = document.getElementById('graph_png');
			Dygraph.Export.asPNG(frequencyGraph, png);
