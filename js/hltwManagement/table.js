...
var Table = function(divId) {
	...
	Table.prototype.createTable = function() {
		...
		this.deleteButton.setAttribute("onClick", "table.deleteHLTW()");
		this.deleteButton.innerHTML = "L&ouml;schen";
		...
		if (everythingOk) {
			...
			$.ajax({
				...
				success : function(data) {
					...
					that.div.innerHTML = "<br><br>Das Hochlastzeitfenster wurde erfolgreich gespeichert!";
	...
	/**
	 * This function deletes the Information of the HLTW from DB (in anualValues and HLTW).
	 */
	Table.prototype.deleteHLTW = function() {

		var providerSelect = document.getElementById("chooseHltwSelect");
		var pavID = providerSelect.options[providerSelect.selectedIndex].value;
		// alert(pavID);
		var that = this;
		...
		$.ajax({
			...
			success : function(data) {
				...
				that.div.innerHTML = "<br><br>Das Hochlastzeitfenster wurde gel&ouml;scht!";
